...
ActiveRecord::Schema.define(version: 2023_03_19_131018) do
  ...
  create_table "addlesses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["order_id"], name: "index_addlesses_on_order_id"
  end
  ...
  add_foreign_key "addlesses", "orders"
